public class Hw2 {
    public static void main(String[] args) {
        ...
        int clases = total / perClass;
        int whiteTotal = clases * white;
        int brownTotal = clases * brown;
        System.out.println("В школе, где " + clases + " классов, нужно " + whiteTotal + " банок белой краски и " + brownTotal + " банок коричневой краски");
